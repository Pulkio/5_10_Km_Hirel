  ...
  return (
    <>
      ...
      <Components.Section color="blue">
          ...
          <p>
            Hirel vous attend pour une matinée de course à pied mémorable (et sans
            trop de souffrance en montée 😉) !
          </p>
          <Components.Card>
      ...
      <Components.Section>
        ...
        <p>
          ...
          vous, filant comme le vent au cœur de la campagne hireloise verdoyante
          🌳. Un cadre authentique en Ille-et-Vilaine pour une expérience qui
          change !
        </p>
        <div className="card-grid">
          ...
          <Components.Card fullwidth>
            ...
            <p>
              À deux pas de ce joyau du patrimoine mondial ! L'air marin et les
              paysages emblématiques de la baie vous donneront des ailes.
            </p>
          </Components.Card>
          ...
          <Components.Card fullwidth>
            ...
            <p>
              ...
              personnalisées aux couleurs de l'événement ! Un souvenir utile et
              stylé de votre première participation.
            </p>
          </Components.Card>
        </div>
        <Components.Card fullwidth color="blue">
            <strong>Alors, prêt(e) pour l'aventure ?</strong>
            <p>Rejoignez-nous pour cette première édition qui promet d'être mémorable ! Places limitées pour préserver l'esprit convivial.</p>
