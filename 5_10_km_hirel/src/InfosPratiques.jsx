                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-800 mb-2">Salle intergénérationnelle d'Hirel</h3>
                  ...
                  <div className="bg-green-50 rounded-xl p-6 border border-green-100">
                    ...
                    <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <p className="font-semibold text-gray-800">Parking du cimetière d'Hirel</p>
                          <p className="text-gray-600 text-sm">Cimetière, 8-16 Rue du Bord de Mer, 35120 Hirel</p>
